...
public class stop extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bgStop = new javax.swing.JLabel();
        btmStop = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        bgStop.setIcon(new javax.swing.ImageIcon(getClass().getResource("/png/stop.png"))); // NOI18N
        getContentPane().add(bgStop, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 870, 460));

        btmStop.setText("jButton1");
        btmStop.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btmStopActionPerformed(evt);
            }
        });
        getContentPane().add(btmStop, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 360, 190, 70));
    ...
    private javax.swing.JLabel bgStop;
