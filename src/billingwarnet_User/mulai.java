...
public class mulai extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bgMulai = new javax.swing.JLabel();
        btnMulai = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        bgMulai.setIcon(new javax.swing.ImageIcon(getClass().getResource("/png/mulaii.png"))); // NOI18N
        getContentPane().add(bgMulai, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 870, 460));

        btnMulai.setText("jButton1");
        btnMulai.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnMulaiActionPerformed(evt);
            }
        });
        getContentPane().add(btnMulai, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 360, 190, 60));
    ...
    private javax.swing.JLabel bgMulai;
